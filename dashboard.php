...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="registrar_funcionario.php" target="iframe_content"><i class="bi bi-person-plus"></i> Registrar Funcionarios</a>
    <a href="registrar_correspondencia.php" target="iframe_content"><i class="bi bi-folder-plus"></i> Registrar Correspondencia</a>
